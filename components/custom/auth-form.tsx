...
function Submit({ isSuccessful }: { isSuccessful: boolean }) {
  ...
  return (
    <button className="md:mx-6 bg-black dark:bg-white rounded-lg text-white dark:text-black w-full md:w-48 h-10 hover:bg-gradient-to-r hover:from-red-500 hover:via-orange-500 hover:to-yellow-500 hover:text-white" type="submit" disabled={pending|| isSuccessful}>
  ...
  <section className="grid h-dvh place-content-center bg-neutral-200 md:bg-white dark:bg-black">
    <Form action={action}>
      ...
      <div className="p-6 w-dvw md:w-auto flex flex-col gap-3">
          ...
          <label htmlFor="email" className="text-xl md:text-2xl font-bold bg-gradient-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent w-fit">Email</label>
          ...
          <label htmlFor="password" className="text-xl md:text-2xl font-bold bg-gradient-to-r from-red-500 to-yellow-500 bg-clip-text text-transparent w-fit">Password</label>
      ...
      <Link href="/">
        <button className="my-8 md:mx-6 bg-black dark:bg-white rounded-lg text-white dark:text-black w-full md:w-48 h-10 hover:bg-gradient-to-r hover:from-red-500 hover:via-orange-500 hover:to-yellow-500 hover:text-white">Cancel</button>
      </Link>
